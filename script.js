const cards = [
  ...
  { icon:"🔥", value:"65", label:"Incendios activos", detail:"20 en combate, 33 controlados y 12 extinguidos" },
  ...
  { icon:"👥", value:"21.698", label:"Personas damnificadas", detail:"341 personas albergadas" },
