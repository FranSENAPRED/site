const cards = [
  ...
  { icon:"👥", value:"21.803", label:"Personas damnificadas", detail:"422 personas albergadas" },
  { icon:"🏚️", value:"4.137", label:"Viviendas destruidas", detail:"Ficha Básica de Emergencia" },
  ...
  { icon:"🤝", value:"1.196", label:"Voluntarios desplegados", detail:"Apoyo humanitario y rehabilitación" }
];
