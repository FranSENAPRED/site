const cards = [
  ...
  { icon:"👥", value:"21.713", label:"Personas damnificadas", detail:"450 personas albergadas" },
  { icon:"🏚️", value:"3.271", label:"Viviendas destruidas", detail:"FIBE" },
  { icon:"📢", value:"214", label:"Mensajes SAE enviados", detail:"Desde el 17/01/2026" },
  { icon:"🚁", value:"137", label:"Aeronaves desplegadas", detail:"CONAF, SENAPRED, EMCO y empresas forestales" },
