const cards = [
  ...
  { icon:"👥", value:"21.764", label:"Personas damnificadas", detail:"426 personas albergadas" },
  ...
  { icon:"🚁", value:"136", label:"Aeronaves desplegadas", detail:"CONAF, SENAPRED, EMCO y empresas forestales" },
